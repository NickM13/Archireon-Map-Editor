...
void CTileSet::render()
{
	glPushMatrix();
	{
		...
		MScissor::getInstance().push(Rect(-GLfloat(m_borderThickness), -GLfloat(m_borderThickness + 20), GLfloat(m_size.x + m_borderThickness * 2), GLfloat(m_size.y + m_borderThickness * 2 + 20)));
