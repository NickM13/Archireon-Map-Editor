...
void CTileSet::input(Sint8& p_interactFlags, Sint8* p_keyStates, Sint8* p_mouseStates, Vector2<Sint32> p_mousePos)
{
	...
	{
		if(p_keyStates[GLFW_KEY_LEFT] == 1 || p_keyStates[GLFW_KEY_A] == 1)
		{
			m_selectedTile.x--;
		...
		if(p_keyStates[GLFW_KEY_RIGHT] == 1 || p_keyStates[GLFW_KEY_D] == 1)
		{
			m_selectedTile.x++;
		...
		if(p_keyStates[GLFW_KEY_UP] == 1 || p_keyStates[GLFW_KEY_W] == 1)
		{
			m_selectedTile.y--;
		...
		if(p_keyStates[GLFW_KEY_DOWN] == 1 || p_keyStates[GLFW_KEY_S] == 1)
		{
			m_selectedTile.y++;
